...
namespace pokesim {
namespace {
template <typename Move, typename BuildMoveTag>
struct BuildMove {
 private:
...
void buildMoveTag(const Pokedex& pokedex, types::registry& registry) {
  if (pokedex.isGameMechanic(GameMechanics::SCARLET_VIOLET)) {
    return dex::forEachMove<BuildMove, BuildMoveTag>(pokedex, registry, GameMechanics::SCARLET_VIOLET);
  }
...
void Pokedex::buildMoves(types::registry& registry) const {
  if (!registry.view<internal::tags::BuildActionMove>().empty()) {
    buildMoveTag<internal::tags::BuildActionMove>(*this, registry);
  }

  if (!registry.view<internal::tags::BuildPokedexMove>().empty()) {
    buildMoveTag<internal::tags::BuildPokedexMove>(*this, registry);
  }
}
}  // namespace pokesim
