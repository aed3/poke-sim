...
class Dex {
 public:
  ...
  enum Status : std::uint8_t {
    NO_STATUS = 0, BRN, FRZ, PAR, PSN, SLP, TOX, /*, FRB, DRO, */ STATUS_TOTAL
  };

  /** @brief Pokemon gender name */
  enum Gender : std::uint8_t {
    NO_GENDER = 0, FEMALE, MALE, GENDER_TOTAL
  };
  ...
  enum Stat : std::uint8_t {
    HP = 0b000001, ATK = 0b000010, DEF = 0b000100, SPA = 0b001000, SPD = 0b010000, SPE = 0b100000, /* SPC = SPA | SPD, */ STAT_TOTAL = 6
  };

 private:
  /** @brief List where `SpeciesNames[SPECIES]` contains the name of the species as a string */
  ...
  /** @brief List where `MoveNames[MOVE]` contains the name of the move as a string */
  ...
  /** @brief List where `AbilityNames[ABILITY]` contains the name of the ability as a string */
  ...
  /** @brief List where `ItemNames[ITEM]` contains the name of the item as a string */
  ...
  /** @brief List where `NatureNames[NATURE]` contains the name of the nature as a string */
  ...
  /** @brief List where `StatusNames[STATUS]` contains the name of the status condition as a string */
  static inline const std::array<std::string, STATUS_TOTAL> StatusNames = {"", "brn", "frz", "par", "psn", "slp", "tox", /* "frb", "dro" */};

  /** @brief List where `GenderNames[GENDER]` contains the name of the gender as a string */
  static inline const std::array<std::string, GENDER_TOTAL> GenderNames = {"", "F", "M"};

  /** @brief List where `TypeNames[TYPE]` contains the name of the type as a string */
  ...
  /** @brief List where `StatNames[STAT]` contains the name of the stat as a string */
  static inline const std::array<std::string, STAT_TOTAL> StatNames = {"HP", "ATK", "DEF", "SPA", "SPD", "SPE", /* "SPC" */};


  /** @brief List where `SpeciesSmogonNames[SPECIES]` contains the Smogon-style name of the species as a string */
  ...
  /** @brief List where `MoveSmogonNames[MOVE]` contains the Smogon-style name of the move as a string */
  ...
  /** @brief List where `AbilitySmogonNames[ABILITY]` contains the Smogon-style name of the ability as a string */
  ...
  /**
   * @brief List where `ItemSmogonNames[ITEM]` contains the Smogon-style name of the item as a string
   *
 ...
 public:
   ...
   */
  static inline Status fromNameToStatusEnum(const std::string& name);

  /**
   * @brief Returns the enum of the gender name string.
   * Returns `NO_GENDER` if the string does not represent a gender.
   */
  static inline Gender fromNameToGenderEnum(const std::string& name);

  /**
   * @brief Returns the enum of the type name string.
   * Returns `NO_TYPE` if the string does not represent a type.
   */
  static inline Type fromNameToTypeEnum(const std::string& name);

  /**
   * @brief Returns `NO_STAT` if the string does not represent a stat.
   */
  static inline Stat fromNameToStatEnum(const std::string& name);

  /**
   * @brief Returns the enum of the species Smogon name string.
   * Returns `MISSING_NO` if the string does not represent a species.
   */
  static inline Species fromSmogonNameToSpeciesEnum(const std::string& name);

  /**
   * @brief Returns the enum of the move Smogon name string.
   * Returns `NO_MOVE` if the string does not represent a move.
   */
  static inline Move fromSmogonNameToMoveEnum(const std::string& name);

  /**
   * @brief Returns the enum of the ability Smogon name string.
   * Returns `NO_ABILITY` if the string does not represent an ability.
   */
  static inline Ability fromSmogonNameToAbilityEnum(const std::string& name);

  /**
   * @brief Returns the enum of the item Smogon name string.
   * Returns `NO_ITEM` if the string does not represent an item.
   */
  static inline Item fromSmogonNameToItemEnum(const std::string& name);

  /**
   * @brief Returns the enum of the species Smogon ID string.
   * Returns `MISSING_NO` if the string does not represent a species.
   */
  static inline Species fromSmogonIDToSpeciesEnum(const std::string& name);

  /**
   * @brief Returns the enum of the move Smogon ID string.
   * Returns `NO_MOVE` if the string does not represent a move.
   */
  static inline Move fromSmogonIDToMoveEnum(const std::string& name);

  /**
   * @brief Returns the enum of the ability Smogon ID string.
   * Returns `NO_ABILITY` if the string does not represent an ability.
   */
  static inline Ability fromSmogonIDToAbilityEnum(const std::string& name);

  /**
   * @brief Returns the enum of the item Smogon ID string.
   * Returns `NO_ITEM` if the string does not represent an item.
   */
  static inline Item fromSmogonIDToItemEnum(const std::string& name);

  /** @brief Converts a string to only have lowercase alphanumeric characters */
  inline static std::string toID(const std::string& name);
};
}  // namespace pokesim
