...
## To ECS
To make the most out of the ECS system's performance, functions should be made as "flat" as possible so components only run on code they use and that code is run all at once for each component that uses it.
