...
namespace Catch {
    ...
    int Session::run() {
        ...
        Catch::cout() << "Tests Started" << std::endl;
...
namespace Catch {
    ...
    Totals Totals::operator - ( Totals const& other ) const {
        ...
        diff.sections = sections - other.sections;
        return diff;
    }
...
namespace Catch {
    ...
    Totals RunContext::runTest(TestCaseHandle const& testCase) {
        ...
        // +++++++++++++++++++++++PRINT TEST NAME BEFORE RUN+++++++++++++++++++++++ //
        // Catch::cout() << std::endl << std::endl << testCase.getTestCaseInfo().name << std::endl;
    ...
    void RunContext::sectionEnded(SectionEndInfo const & endInfo) {
        ...
        if (!m_activeSections.empty()) {
            ...
            if (m_activeSections.back()->isSuccessfullyCompleted()) {
    ...
    void RunContext::subSectionEnded() {
        m_totals.sections.passed++;
    }
...
void ConsoleReporter::printTestFilters() {
    if (m_config->testSpec().hasFilters()) {
        Colour guard(Colour::BrightWhite);
